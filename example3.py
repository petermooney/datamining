...
def readAndPrintQueryResultsFromCSVFile(filenameIn,filenameOut,chosenCategory):
	...
	with open(filenameIn, 'r') as csvfile:
		...
		for row in csvreader:
			...
			# only if the current category equals our chosen category do we consider it 
			# and subsequently print it out - categories that don't match are ignored. 
