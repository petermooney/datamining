...
def main():
	...
	pointsWithinGBB = findPointsWithinAGeographicBoundingBox("OSM_BritishIsles_Amenities.sqlite",51.7279,-0.5713,51.2611,0.3227,"bicycle_rental")
	
	# let's write the results to a CSV file - we will just write the coordinates
	outputCSVFile = open("PointsWithinGBB_Bicycle.csv","w")
